...
// Get Structure
	...
	// Widgets
		import HomePageTopWidgets from "./Components/HomePageTopWidgets";
		import CurrentFormWidgets from "./Components/CurrentFormWidgets";
	// Batting
	...
	// Ranking
		import HomePageWorldRankingsWidget from "./Components/HomePageWorldRankingsWidget";
		import PreviousFullGameTable from "./Components/PreviousFullGameTable";
...
export default class Layout extends React.Component {
  ...
  componentWillUpdate(NewProps, NewState){  
  		GameNum = NewProps.Player.games.length; 
  }
  ...
  render() {
		return (
				<section id="basicInfo">
					<div class="row">
						<div class="col-md-6">
							<h1 class="page-header">Dashboard : {this.props.UI.PLAYER.UserName}</h1>
						</div>
