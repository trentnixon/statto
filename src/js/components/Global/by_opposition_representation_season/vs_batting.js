...
var T=0,HSP=0,HS=0,A=0,SR=0,OT=0,BF=0,ach='ach ach_1';
let Batting_VS = [];
...
export default class VS_Table extends React.Component {
	...
	CreateStats(Player, Facts)
		...
		Batting_VS.push(
				{Title:'Runs Scored',	Color:ach, Total:T,		Career:Facts["0"].TotalScore},
				{Title:'Highest Score',	Color:ach, Total:HS,	Career:CHS},
				{Title:'Average',		Color:ach, Total:A,		Career:Facts["0"].Average},
				{Title:'Strike Rate',	Color:ach, Total:SR,	Career:Facts["0"].StrikeRate}
			)
	}	
	...
	<div class="col-md-4">
			<div class="panel panel-inverse" data-sortable-id="table-basic-4">
				<div class="panel-heading">
					<h4 class="panel-title">Batting</h4>
				</div>
