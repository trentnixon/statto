...
var Years=[],year=[],Notouts=[],NewArrays,Overview=[],Count=0,Limit=0,TH=[];
...
export default class BasicStats extends React.Component {
	...
	componentWillMount(){ 
		...
		Count = this.props.BATTING.Facts["0"].hundreds;
	...
	render () {
			return (
				<div id="lessthan20">
					<Feeder 
						Title="Innings over 100"
						WidgetTitle="Career 100's"
						WidgetCount={Count}
