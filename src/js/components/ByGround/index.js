...
let Label="By Ground", Selected="Ground Selected", Found="Games Found", Header="Select a Ground"
...
export default class VS extends React.Component {
	...
	render () {	
		if(this.props.UI.items.SelectGroundArray)
			{
			return (
				<section id="basicInfo">
					<div class="row">
						<div class="col-md-6">
							<h3 class="page-header"><small>{Label}: </small> {this.props.UI.items.SelectGround}</h3>
						</div>
						<div class="col-md-6">
							<VS_Select {...this.props} Player={this.props.BATTING.BattingObject}/>
						</div>
					</div>
						<VS_TotalGames Player={this.props.UI.items.SelectGroundArray} />
						<VS_Batting Player={this.props.UI.items.SelectGroundArray}/>
						<VS_Bowling Player={this.props.UI.items.SelectGroundArray}/>
						<VS_Keeping Player={this.props.UI.items.SelectGroundArray}/>
						<VS_Table {... this.props} Player={this.props.UI.items.SelectGroundArray}/>
				</section>
			)
		}
		else
