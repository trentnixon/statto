...
export default class VS extends React.Component {
	...
	render () {	
		if(this.props.UI.items.SelectYearArray)
			{
			return (
				<section id="basicInfo">
					<div class="row">
						...
						<div class="col-md-6">
							<h3 class="page-header"><small>Year : </small> {this.props.UI.items.SelectYear}</h3>
						</div>
						<div class="col-md-6">
							<VS_Select {...this.props} Player={this.props.BATTING.BattingObject}/>
						</div>
					</div>
						<VS_TotalGames Player={this.props.UI.items.SelectYearArray} />
						<VS_Batting Player={this.props.UI.items.SelectYearArray}/>
						<VS_Bowling Player={this.props.UI.items.SelectYearArray}/>
						<VS_Keeping Player={this.props.UI.items.SelectYearArray}/>
						<VS_Table {... this.props} Player={this.props.UI.items.SelectYearArray}/>	
				</section>
			)
		}
		else
